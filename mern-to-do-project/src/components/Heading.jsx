  ...
  return (
    <div className='pt-8 '>
        <div className='flex items-center justify-between text-white text-3xl font-bold sm:text-5xl'>
          ...
          <div className='flex text-sm font-medium cursor-pointer hover:scale-110 transition border-white border-2 px-2 gap-2 py-1 rounded-md items-center bg-red-600'>
            <h1>Give Up</h1>
            <h1><FaSignOutAlt /></h1>
          </div>
